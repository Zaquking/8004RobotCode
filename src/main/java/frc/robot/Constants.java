...
package frc.robot;
//vueggulerbvljadbhjbvbikvk.jv h.kv bj
...
public final class Constants {
	...
	public static final int LEFT_STICK_Y = 0; //The Left Stick of the Driving Contoller
	public static final int RIGHT_STICK_Y = 1;//The Right Stick of the Driving Controller
